 ...
 ** NEED TO PUT THOSE IN      
    set_distortion_enabled(1); // activer la distorsion : 0: d?sactive les fonctions, 1: activation de la distorsion
    set_distortion_level(98); // niveau de distorsion ? appliquer sur 100% 
