...
HD_PWD='C:/Users/adams/Desktop/S4/Projet/ProjetS4/Code/AudioMX-Projet-S4/projet_vivado/projet_vivado.runs/main_design_xfft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_design_xfft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_design_xfft_0_0.tcl
