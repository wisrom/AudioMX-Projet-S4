...
HD_PWD='C:/Users/gabma/Projet S4/labo1_final/labo1/projet_vivado/projet_vivado.runs/main_design_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_design_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_design_axi_uartlite_0_0.tcl
